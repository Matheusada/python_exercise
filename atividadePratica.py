...
if (qtd_produto < 200):  #O pção de vários prints para espeficicação na mensagem da quantidade de produtos escolhidos
    ...
    print('SEM DESCONTO ficaria R$ {:.2f}'.format(valor_sem_desconto))
print('A empresa agradece a sua visita! Volte sempre!')
